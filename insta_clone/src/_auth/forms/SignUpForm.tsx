        ...
        <>
            <Form {...form}>
                <div className="sm:w-420 flex-center flex-col">
                    ...
                    <h2 className="h3-bold md:h2-bold pt-5 sm:pt-12">Create a new accouont</h2>
                    <p className="text-light-3 small-medium md:base-regular mt-2">To use Instagarm, please enter your account details</p>
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input type="text"
                                            autoFocus
                                            autoComplete="off" className="shad-input" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
